...
import Link from 'next/link';
	...
	function TwitterIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://twitter.com/jubstacheit">
				...
				<p className='self-end font-base'>Twitter</p>
			</Link>
		);
	}
	...
	function GitHubIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://github.com/jubstacheit">
				...
				<p className='self-end font-base'>Github</p>
			</Link>
		);
	}
	...
	function MastoIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://rivals.space/@Jubstacheit">
				...
				<p className='self-end font-base'>Mastodon</p>
			</Link>
		)
	}
	...
	function InstaIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://www.instagram.com/jubstacheit_">
				...
				<p className='self-end font-base'>Instagram</p>
			</Link>
		)
	}
	...
	function BskyIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://bsky.app/profile/jubstacheit.bsky.social">
				...
				<p className='self-end font-base'>Bluesky</p>
			</Link>
		)
	}
	...
	function SteamIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://steamcommunity.com/id/jubstacheitt">
				...
				<p className='self-end font-base'>Steam</p>
			</Link>	
	)
	}
	...
	function AniIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://anilist.co/user/Jubstacheit/">
				...
				<p className='self-end font-base'>Anilist</p>
			</Link>
		)
	}
	...
	function LetterIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://letterboxd.com/Jubstacheit/">
				...
				<p className='self-end font-base'>Letterboxd</p>
			</Link>
		)
	}
	...
	function SpotifyIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://open.spotify.com/user/31kszclsxbfcqbmggpf7wsvc5jce">
				...
				<p className='self-end font-base'>Spotify</p>
			</Link>
	)
	}
	...
	function LastIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://last.fm/user/jubstacheit_">
				...
				<p className='self-end font-base'>LastFM</p>
			</Link>
		)
	}
	...
	function PaypalIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="https://paypal.me/jubstacheitviviane">
				...
				<p className='self-end font-base'>Paypal</p>
			</Link>
		)
	}
	...
	function GmailIcon() {
		return (
			<Link className='flex flex-row space-x-2 text-center align-middle justify-center' href="mailto:dessaintviviane@gmail.com">
				...
				<p className='self-end font-base'>Email</p>
			</Link>
		)
	}
	...
	export default function HomeLinks() {
		return (
			<Card className="z-20 absolute right-0 self-center w-auto animate-slide-rotate-ver-right opacity-30 transition peer-hover: hover:opacity-100 group select-none">
